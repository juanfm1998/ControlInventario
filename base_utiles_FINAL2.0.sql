...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-07-2020 a las 23:23:34
...
(7, 'FA001', 'Comas', '15-06-2020', 0, 134, 134),
(9, 'CA001', 'Tay loi', '15-06-2020', 49, 102, 151);
...
(1, 'AR001', 'Archivador cartón oficio', 56),
(2, 'AR002', 'Archivador cartón 1/2 oficio', 24),
(3, 'BO002', 'Bolsa politileno 21x41x5', 1),
(4, 'BO001', 'bolsa blanco 21x24', 798),
(5, 'CN001', 'Cinta de embalaje', 0),
(6, 'CN002', 'Cinta  scotch pegafan', 15),
(7, 'CL001', 'Clips', 11585),
...
(14, 'CO001', 'Corrector', 8),
(15, 'CU401', 'Cuaderno A4', 2),
(16, 'CU001', 'Cuaderno chico', 5),
(17, 'CA001', 'Cartulina duplex', 14),
(18, 'EN001', 'Engrapadora', 8),
(19, 'FA001', 'Fastener', 129),
(20, 'FO001', 'Folder manila oficio', 121),
(21, 'FA401', 'Folder manila A4', 7),
(22, 'GR001', 'Grapas 23/10 oficio (barras)', 35),
(23, 'GR002', 'Grapas 26/6 A4 (barras)', 232),
...
(31, 'MA001', 'Masking pegafan', 0),
(32, 'MC001', 'micas A4', 105),
(33, 'PD001', 'Plumón delgado rojo', 1),
(34, 'PG001', 'Plumón grueso negro indeleble', 20),
(35, 'PG002', 'Plumón grueso rojo', 0),
(36, 'PG003', 'Plumón grueso azul', 0),
(37, 'PG004', 'Plumón grueso indeleble', 0),
(38, 'PA002', 'Papel bound A4', 84370),
(39, 'PA003', 'Papel contact ', 0),
(40, 'PA004', 'Papel bound arco iris', 0),
(41, 'PE001', 'Perforador', 5),
(42, 'PL001', 'Papel lustre (pliegos)', 208),
(43, 'PO001', 'Porta clip artesco', 19),
(44, 'PO002', 'Porta CD', 57),
(45, 'PO003', 'Porta Papel A4', 0),
(46, 'RE001', 'Resaltador', 1),
(47, 'RE002', 'Regla', 9),
(48, 'TA001', 'Tajador', 5),
(49, 'TI001', 'Tijera', 7),
...
(118, 14, 'PG001', '09-06-2020', 21, 1, 20),
...
(202, 3, 'CN002', '01-07-2020', 16, 1, 15),
...
--
ALTER TABLE `empleados`
  MODIFY `id_emp` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `productos`
  MODIFY `id_prod` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;

--
-- AUTO_INCREMENT de la tabla `salidas`
--
ALTER TABLE `salidas`
  MODIFY `id_salida` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=236;
